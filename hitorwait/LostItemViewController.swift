...
//        getItemDetails()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if lat != 0.0 {
            let params = ["view":"lostItemView","user":(CURRENT_USER?.username)! ?? "","time":Date().timeIntervalSince1970,"lat":String(describing: lat),"lon":String(describing:lon)] as [String: Any]
